...
public class QuadraticProbingHashTable<AnyType>
{
    ...
    private static class HashEntry<AnyType>
    {
        ...
        public HashEntry(AnyType e, AnyType k, boolean i)
        {
            element = e;
            key = k;
            isActive = i;
    ...
    // Here are my custom methods for the assignment

    /**
     * Method that takes a key and stores an object at the place the key hashes to
     * @param key the key to objects location
    ...
    public boolean put( AnyType key, AnyType value)
    {
        ...
        array[ currentPos ] = new HashEntry<>( value, key, true );
        theSize++;
